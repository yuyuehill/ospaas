...
delete from instance_info_caches where instance_uuid in (select uuid from instances where vm_state='deleted');

delete from instance_metadata where instance_uuid in (select uuid from instances where vm_state='deleted');

delete from instance_system_metadata where instance_uuid in (select uuid from instances where vm_state='deleted');

delete from security_group_instance_association where instance_uuid in (select uuid from instances where vm_state='deleted');

delete from virtual_interfaces where instance_uuid in (select uuid from instances where vm_state='deleted');

update fixed_ips set instance_uuid=null where instance_uuid in (select uuid from instances where vm_state='deleted');
